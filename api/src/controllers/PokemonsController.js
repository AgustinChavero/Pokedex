...
const createPokemon = async (name, hp, attack, defense, speed, height, weight) => {
    const pokemonCreate = await Pokemon.create({name, hp, attack, defense, speed, height, weight});
